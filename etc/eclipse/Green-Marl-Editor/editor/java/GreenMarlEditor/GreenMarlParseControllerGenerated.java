...
public class GreenMarlParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("Green-Marl");
  ...
  { 
    GreenMarlParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = GreenMarlParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = GreenMarlParseControllerGenerated.class.getResourceAsStream(TABLE);
  ...
  { 
    return GreenMarlParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
