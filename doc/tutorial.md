...
There is only one statement in the precedure body. Interestingly the statement is enclosed within a bracket \[ \]. 
...
For your information, the actual shell command invoked by the previous make is as following:
...
However, it is always possible to modify the generated code if it is wanted for what reason,
