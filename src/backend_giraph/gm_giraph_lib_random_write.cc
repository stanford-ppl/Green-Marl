...
void gm_giraphlib::generate_message_create_for_random_write(
...
class giraph_random_write_rhs_t : public gm_apply
{
public:
    giraph_random_write_rhs_t(ast_sentblock* _sb, gm_symtab_entry* _sym, gm_giraphlib* l, gm_code_writer& b) 
...
void gm_giraphlib::generate_message_payload_packing_for_random_write(ast_assign *a, gm_code_writer& Body)
{
    ...
    //printf("sb:%p, sym:%p\n", sb, sym);
    giraph_random_write_rhs_t T (sb, sym, this, Body);
