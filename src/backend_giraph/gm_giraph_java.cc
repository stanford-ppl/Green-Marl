...
const char* gm_giraph_gen::get_type_string(int gm_type)
{
    switch(gm_type) {
...
const char* gm_giraph_gen::get_type_string(ast_typedecl* T, bool is_master)
{
...
void gm_giraph_gen::generate_sent_block(ast_sentblock* sb, bool need_brace)
{
...
void gm_giraph_gen::generate_expr_nil(ast_expr* e)
{
    get_lib()->generate_expr_nil(e, Body);
}

void gm_giraph_gen::generate_expr_minmax(ast_expr* e)
{
...
void gm_giraph_gen::generate_lhs_field(ast_field* f)
{
...
void gm_giraph_gen::generate_rhs_field(ast_field* f)
{
...
void gm_giraph_gen::generate_sent_assign(ast_assign *a)
{
    // normal assign
    if (is_master_generate()) {
...
void gm_giraph_gen::generate_expr_abs(ast_expr * e)
{
    Body.push("Math.abs(");
    generate_expr(e->get_left_op());
    Body.push(")");
...
void gm_giraph_gen::generate_expr_inf(ast_expr *e)
{
    char temp[256];
