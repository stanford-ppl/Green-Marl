...
// additional info
        ...
        { "N_S:Add:Void:1:Node", GM_BLTIN_SET_ADD, AUX_INFO(GM_BLTIN_INFO_MUTATING, GM_BLTIN_MUTATE_GROW) }, { "N_S:Remove:Void:1:Node", GM_BLTIN_SET_REMOVE,
                AUX_INFO(GM_BLTIN_INFO_MUTATING, GM_BLTIN_MUTATE_SHRINK) }, { "N_S:Has:Bool:1:Node", GM_BLTIN_SET_HAS, "" }, { "N_S:Union:Void:1:N_S",
                GM_BLTIN_SET_UNION, AUX_INFO(GM_BLTIN_INFO_MUTATING, GM_BLTIN_MUTATE_GROW) }, { "N_S:Intersect:Void:1:N_S", GM_BLTIN_SET_INTERSECT,
                AUX_INFO(GM_BLTIN_INFO_MUTATING, GM_BLTIN_MUTATE_SHRINK) }, { "N_S:Complement:Void:1:N_S", GM_BLTIN_SET_COMPLEMENT,
                AUX_INFO(GM_BLTIN_INFO_MUTATING, GM_BLTIN_MUTATE_SHRINK) }, { "N_S:IsSubsetOf:Bool:1:N_S", GM_BLTIN_SET_SUBSET, "" },

        // Order:
        { "N_O:PushBack:Void:1:Node", GM_BLTIN_SET_ADD_BACK, AUX_INFO(GM_BLTIN_INFO_MUTATING, GM_BLTIN_MUTATE_GROW) }, { "*Push", GM_BLTIN_SET_ADD_BACK,
                AUX_INFO(GM_BLTIN_INFO_MUTATING, GM_BLTIN_MUTATE_GROW) }, { "N_O:PushFront:Void:1:Node", GM_BLTIN_SET_ADD,
                AUX_INFO(GM_BLTIN_INFO_MUTATING, GM_BLTIN_MUTATE_GROW) }, { "N_O:PopBack:Node:0", GM_BLTIN_SET_REMOVE_BACK,
                AUX_INFO(GM_BLTIN_INFO_MUTATING, GM_BLTIN_MUTATE_SHRINK) }, { "N_O:PopFront:Node:1:Node", GM_BLTIN_SET_REMOVE,
                AUX_INFO(GM_BLTIN_INFO_MUTATING, GM_BLTIN_MUTATE_SHRINK) }, { "*Pop", GM_BLTIN_SET_REMOVE,
                AUX_INFO(GM_BLTIN_INFO_MUTATING, GM_BLTIN_MUTATE_SHRINK) }, { "N_O:Has:Bool:1:Node", GM_BLTIN_SET_HAS, "" },
        //{"NodeO:Front:Node:0",         GM_BLTIN_SET_PEEK,         ""},
        //{"NodeO:Back:Node:0",          GM_BLTIN_SET_PEEK_BACK,    ""},

        // Seq:
        { "N_Q:PushBack:Void:1:Node", GM_BLTIN_SET_ADD_BACK, AUX_INFO(GM_BLTIN_INFO_MUTATING, GM_BLTIN_MUTATE_GROW) }, { "*Push", GM_BLTIN_SET_ADD_BACK,
                AUX_INFO(GM_BLTIN_INFO_MUTATING, GM_BLTIN_MUTATE_GROW) }, { "N_Q:PushFront:Void:1:Node", GM_BLTIN_SET_ADD,
                AUX_INFO(GM_BLTIN_INFO_MUTATING, GM_BLTIN_MUTATE_GROW) }, { "N_Q:PopBack:Node:0", GM_BLTIN_SET_REMOVE_BACK,
                AUX_INFO(GM_BLTIN_INFO_MUTATING, GM_BLTIN_MUTATE_SHRINK) }, { "N_Q:PopFront:Node:1:Node", GM_BLTIN_SET_REMOVE,
                AUX_INFO(GM_BLTIN_INFO_MUTATING, GM_BLTIN_MUTATE_SHRINK) }, { "*Pop", GM_BLTIN_SET_REMOVE,
                AUX_INFO(GM_BLTIN_INFO_MUTATING, GM_BLTIN_MUTATE_SHRINK) },
