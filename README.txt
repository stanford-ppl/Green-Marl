...
2.2 Directories
  ...
  <top>/obj :  Object (.o) files during compilation
  <top>/test:  Test routines for compiler development
  <top>/bin :  Compiler binary (gm_comp)  
  ...
  <top>/apps/output_cpp/generated : C++ codes generated by the gm_comp
  <top>/apps/output_cpp/src       : C++ 'main' code for sample applications
  <top>/apps/output_cpp/data      : Directory for data files 
  <top>/apps/output_cpp/bin       : Directory for compiled binaries
  ...
  <top>/apps/output_cpp/gm_graph/lib  : gm_graph library (.a)
...
4.7 Adding your own Green-Marl Program
   ...
   Refer to XXXX.txt which provides a walk-through to write your own Green-Marl
